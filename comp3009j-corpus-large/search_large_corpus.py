...
def corpus_indexing(docs_dir):
    ...
    term_frequency = {}
    # Folder traversal
    for documents_dir1 in os.listdir(docs_dir):
        try:
            for file_name in os.listdir(docs_dir + "/" + documents_dir1):
                try:
                    document_file_name = docs_dir + "/" + documents_dir1 + "/" + file_name
    ...
    weights = {"AvgDocNum": avg_doc_num, "DocNum": file_count, "K1": 1, "B": 0.75,
               "InvertedIndex": inverted_index, "DocLen": doc_len_dict,
